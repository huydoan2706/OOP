...
public class PlayerThree extends Player{
    ...
    public void ONE(){
        ...
        else if (toa_do_3.equals(homes[1])){
        ...
        else if (toa_do_3.equals(homes[2])){
